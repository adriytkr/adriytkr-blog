...
import ArticleLayout from '@/features/articles/components/article/ArticleLayout.vue';
import ArticleSection from '@/features/articles/components/article/ArticleSection.vue';

import MathDisplay from '@/features/articles/components/math/MathDisplay.vue';
import MathInline from '@/features/articles/components/math/MathInline.vue';

import DatasetTable from '@/features/articles/components/math/DatasetTable.vue';

import TheDesmos from '@/features/articles/components/math/TheDesmos.vue';

import VariableInput from '@/features/articles/components/math/VariableInput.vue';
import WarningBox from '@/features/articles/components/math/WarningBox.vue';
...
<template>
  ...
  >
    ...
    <ArticleSection title="How to compute the best-fitting line?" id="compute">
      ...
      <MathDisplay formula="\text{SSE}=\sum_{i=1}^n(y_i-(ax_i+b))^2"/>
      <p>
      ...
      <MathDisplay formula="\frac{\partial\text{SSE}}{\partial a}=-2\sum_{i=1}^n{x_i(y_i-ax_i-b)}" />
      <MathDisplay formula="\frac{\partial\text{SSE}}{\partial b}=-2\sum_{i=1}^n{x_i(y_i-ax_i-b)}" />
      <p>
...
\end{align*}
      "/>
      <p>
        Substitute <MathInline formula="b"/> into the quation
      </p>
      <p>
        Remember also that
      </p>
