import type {Point} from '@/features/articles/types/math';
import type {TheScale} from '@/features/articles/types/d3';
import type {Components,GraphCanvasOptions,Size} from '@/features/articles/types/desmos';
...
export default function(props:GraphCanvasOptions){
  ...
  function drawFunctions(xS:TheScale,yS:TheScale){
    const theme=getTheme(document.documentElement);
